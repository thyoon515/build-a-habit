...
# Task.create!(title: 'Walk the dogs', start: '2023-05-30T07:45:00', end: '2023-05-30T08:45:00', allDay: false, category_id: Category.first.id, priority_id: Priority.first.id, user_id: User.first.id)
